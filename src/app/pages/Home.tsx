...
export function Home() {
  ...
  const content = {
    ko: {
      ...
      heroSub: <>한국과 중국, 두 언어로 당신의 권리를 지킵니다.<br /><span className="text-slate-400/80">韩国与中国，用两种语言守护您的权利。</span></>,
      quickMenu: {
        title: <>Quick<br />Menu</>,
        online: "온라인상담",
        wechat: "위챗상담",
    ...
    zh: {
      ...
      strengths: {
        ...
        items: [
          ...
          {
            title: "源自中国现地经验的文化理解",
            desc: "法律问题不仅仅是条文의 解释。只有理解中国的商业惯例、家庭文化和社会背景, 才能得出真正的解决方案。吴东宪律师拥有在中国苏州、北京、广西省直接生活和工作的经验。"
          },
          {
      ...
      services: {
        ...
        items: [
          ...
          {
            title: "가사 · 继承 (家事·继承)",
            desc: "离婚财产分割、中国法院离婚판결의 韩国国内效力、中国境内财产在韩继承程序指导。"
          }
        ],
        detail: "查看详情"
      },
      cases: {
        ...
        items: [
          ...
          { tag: "民사·金融", title: "P2P 连带保证债务辩护", outcome: "基于《网贷法》의 特殊性，获认责任范围限制。" },
      ...
      legalInfo: {
        ...
        desc: "用易懂의 语言整理复杂的行政、刑事、居留程序。包含中文解析。",
        soon: "准备中",
        items: [
          ...
          { title: "中国离婚判决，在韩国能执行吗？", tags: ["#家사", "#继承"], excerpt: "中国法院判决在韩国境内的效力及财产分割程序。" },
          { title: "涉华进出口合同，原文审核要点", tags: ["#合同", "#涉华"], excerpt: "中文原文合同中经常被忽视의 7 个风险条款。" },
          { title: "收到强制遣返令怎么办 — 异议申请程序", tags: ["#出入境", "#行政"], excerpt: "从不服、异议申请到行政诉讼의 实务流程指南。" },
        ]
      },
      testimonials: {
        eyebrow: "客户评价",
        title: <>与韩桥并肩作战后的评价</>,
        desc: "吴东宪律师帮助恢复权利의 客户评价。",
      ...
      consult: {
        eyebrow: "Consultation",
        title: "韩桥咨询申请",
        desc: "请使用您认为方便의 中文或韩语留言。吴东宪律师将在 24 小时内直接回复。"
      },
      form: {
        title: "咨询申请表",
        badge: "Intake · 中 / 韩 / 英",
