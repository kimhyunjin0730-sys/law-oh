...
export function Cases() {
  ...
  const content = {
    ko: {
      ...
      contactTitle: "당신의 사건도 한교의 또 다른 성공 사례가 될 수 있습니다.",
      contactPrefix: "당신의 사건도 ",
      contactHighlight: "한교의 또 다른 성공 사례",
    ...
    zh: {
      title: "成功案例",
      subtitle: "韩桥通过透彻的分析和缜密的战略所取得的主要胜诉及咨询案例。",
      contactTitle: "您的案件也能成为韩桥的下一个成功案例。",
      contactPrefix: "您的案件也能成为",
      contactHighlight: "韩桥的下一个成功案例",
      contactSuffix: "。",
    ...
    en: {
      title: "Success Cases",
      subtitle: "Major success stories and consulting cases achieved through HANGYO's thorough analysis and meticulous strategy.",
      contactTitle: "Your case can be HANGYO's next success story.",
      contactPrefix: "Your case can be ",
      contactHighlight: "HANGYO's next success story",
      contactSuffix: ".",
