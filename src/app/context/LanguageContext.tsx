...
const translations = {
  ko: {
    ...
    'footer.desc': '한국에서 법적 문제에 부딪혔을 때, 가장 두려운 것은 \'내 말이 제대로 전달되지 않는 것\'입니다. 비컴은 중국 현지 경험을 바탕으로 당신의 이야기를 당신의 언어로 직접 듣습니다.',
    'footer.contact': 'Contact Us',
    'footer.links': 'Quick Links',
    'footer.rights': 'Copyright © 2026 BECOME Law Firm. All rights reserved.',
  ...
  zh: {
    ...
    'footer.desc': '在韩国遇到法律问题时，最害怕的是“我的话没有被正确传达”。BECOME 律师事务所以在中国当地的经验为基础，用您的语言直接倾听您的故事。',
    'footer.contact': '联系我们',
    'footer.links': '快速链接',
    'footer.rights': 'Copyright © 2026 BECOME 律师事务所. 保留所有权利。',
    'footer.disclaimer': '本网站内容仅供参考，不构成具体案件的法律咨询。',
  },
  en: {
    'nav.home': 'BECOME Law Firm',
    'nav.about': 'About Attorney',
    ...
    'footer.desc': 'When facing legal issues in Korea, the biggest fear is miscommunication. BECOME Law Firm listens to your story directly in your language based on our local experience in China.',
    'footer.contact': 'Contact Us',
    'footer.links': 'Quick Links',
    'footer.rights': 'Copyright © 2026 BECOME Law Firm. All rights reserved.',
