...
export function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white text-slate-900 tracking-tight">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center">
                <img
                  ...
                  alt="HANGYO"
                  className={clsx(
                    "h-32 lg:h-36 w-auto transition-all duration-300",
                ...
                {navLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      to={link.path}
                      className={clsx(
                        "inline-flex items-center text-lg font-bold transition-colors duration-300 py-14 border-b-2",
                        active
                          ? overlay
      ...
      <main className={clsx("flex-grow", isHome ? "-mt-[200px]" : "bg-white")}>
        <Outlet />
      </main>
